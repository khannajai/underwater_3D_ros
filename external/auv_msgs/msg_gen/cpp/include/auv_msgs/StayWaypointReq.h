/* Auto-generated by genmsg_cpp for file /home/osl/src/hwu-osl-ros-pkg/hwu_osl_common/auv_msgs/msg/StayWaypointReq.msg */
#ifndef AUV_MSGS_MESSAGE_STAYWAYPOINTREQ_H
#define AUV_MSGS_MESSAGE_STAYWAYPOINTREQ_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct StayWaypointReq_ {
  typedef StayWaypointReq_<ContainerAllocator> Type;
  ...
  StayWaypointReq_(const ContainerAllocator& _alloc)
  : header(_alloc)
  , goal(_alloc)
  , altitude_mode(false)
  , disable_axis(_alloc)
  ...
  typedef boost::shared_ptr< ::auv_msgs::StayWaypointReq_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::auv_msgs::StayWaypointReq_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct StayWaypointReq
typedef  ::auv_msgs::StayWaypointReq_<std::allocator<void> > StayWaypointReq;

typedef boost::shared_ptr< ::auv_msgs::StayWaypointReq> StayWaypointReqPtr;
typedef boost::shared_ptr< ::auv_msgs::StayWaypointReq const> StayWaypointReqConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::auv_msgs::StayWaypointReq_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::auv_msgs::StayWaypointReq_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::auv_msgs::StayWaypointReq_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::auv_msgs::StayWaypointReq_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::auv_msgs::StayWaypointReq_<ContainerAllocator> > {
  static const char* value() 
  {
    return "669505d5bfd6c5bc3c0e36dd25725479";
  }

  static const char* value(const  ::auv_msgs::StayWaypointReq_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x669505d5bfd6c5bcULL;
  static const uint64_t static_value2 = 0x3c0e36dd25725479ULL;
};

template<class ContainerAllocator>
struct DataType< ::auv_msgs::StayWaypointReq_<ContainerAllocator> > {
  static const char* value() 
  {
    return "auv_msgs/StayWaypointReq";
  }
...
template<class ContainerAllocator>
struct Definition< ::auv_msgs::StayWaypointReq_<ContainerAllocator> > {
  static const char* value() 
  {
    return "# Position holding request to pilot.\n\
...
template<class ContainerAllocator> struct HasHeader< ::auv_msgs::StayWaypointReq_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::auv_msgs::StayWaypointReq_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::auv_msgs::StayWaypointReq_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::auv_msgs::StayWaypointReq_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::auv_msgs::StayWaypointReq_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // AUV_MSGS_MESSAGE_STAYWAYPOINTREQ_H
