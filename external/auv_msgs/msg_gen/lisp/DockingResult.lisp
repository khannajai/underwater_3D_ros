...
(cl:defmethod cl:initialize-instance :after ((m <DockingResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DockingResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name auv_msgs-msg:<DockingResult> is deprecated: use auv_msgs-msg:DockingResult instead.")))
...
(cl:defmethod error_num-val ((m <DockingResult>))
...
(cl:defmethod error_string-val ((m <DockingResult>))
