...
(cl:defmethod cl:initialize-instance :after ((m <Test>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Test)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name auv_msgs-msg:<Test> is deprecated: use auv_msgs-msg:Test instead.")))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <Test>))
