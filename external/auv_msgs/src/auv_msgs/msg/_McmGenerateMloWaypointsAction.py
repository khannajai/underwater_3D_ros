"""autogenerated by genpy from auv_msgs/McmGenerateMloWaypointsAction.msg. Do not edit."""
import sys
...
class McmGenerateMloWaypointsAction(genpy.Message):
  _md5sum = "fa43272ede682498cfb2b0c291f4613a"
  _type = "auv_msgs/McmGenerateMloWaypointsAction"
...
"""
  ...
  _slot_types = ['auv_msgs/McmGenerateMloWaypointsActionGoal','auv_msgs/McmGenerateMloWaypointsActionResult','auv_msgs/McmGenerateMloWaypointsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(McmGenerateMloWaypointsAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.McmGenerateMloWaypointsActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.McmGenerateMloWaypointsActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.McmGenerateMloWaypointsActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.McmGenerateMloWaypointsActionGoal()
      self.action_result = auv_msgs.msg.McmGenerateMloWaypointsActionResult()
      self.action_feedback = auv_msgs.msg.McmGenerateMloWaypointsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.mlo_wp_variable_prefix
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.mlo_wp_variable_prefix = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.mlo_wp_variable_prefix = str[start:end]
      _x = self
      start = end
      end += 12
