"""autogenerated by genpy from auv_msgs/ObjectOperationActionResult.msg. Do not edit."""
import sys
...
class ObjectOperationActionResult(genpy.Message):
  _md5sum = "79f807792c7ffe17b288001ef35f2f24"
  _type = "auv_msgs/ObjectOperationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/ObjectOperationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObjectOperationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.ObjectOperationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.ObjectOperationResult()
