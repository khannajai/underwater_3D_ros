"""autogenerated by genpy from auv_msgs/FollowLeaderWithPathAction.msg. Do not edit."""
import sys
...
class FollowLeaderWithPathAction(genpy.Message):
  _md5sum = "d44088e4e7dea956300e9a94461a2d05"
  _type = "auv_msgs/FollowLeaderWithPathAction"
...
"""
  ...
  _slot_types = ['auv_msgs/FollowLeaderWithPathActionGoal','auv_msgs/FollowLeaderWithPathActionResult','auv_msgs/FollowLeaderWithPathActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowLeaderWithPathAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.FollowLeaderWithPathActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.FollowLeaderWithPathActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.FollowLeaderWithPathActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.FollowLeaderWithPathActionGoal()
      self.action_result = auv_msgs.msg.FollowLeaderWithPathActionResult()
      self.action_feedback = auv_msgs.msg.FollowLeaderWithPathActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.action_goal.goal.path_provided))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.path_provided,) = _struct_B.unpack(str[start:end])
      self.action_goal.goal.path_provided = bool(self.action_goal.goal.path_provided)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
