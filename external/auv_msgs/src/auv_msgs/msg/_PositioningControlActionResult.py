"""autogenerated by genpy from auv_msgs/PositioningControlActionResult.msg. Do not edit."""
import sys
...
class PositioningControlActionResult(genpy.Message):
  _md5sum = "9cd21762fe72ccda7bef5f960514fa58"
  _type = "auv_msgs/PositioningControlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/PositioningControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PositioningControlActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.PositioningControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.PositioningControlResult()
