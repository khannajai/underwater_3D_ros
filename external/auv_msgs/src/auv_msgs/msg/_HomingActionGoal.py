"""autogenerated by genpy from auv_msgs/HomingActionGoal.msg. Do not edit."""
import sys
...
class HomingActionGoal(genpy.Message):
  _md5sum = "900415722beda7f7b3df991f9b7ff964"
  _type = "auv_msgs/HomingActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','auv_msgs/HomingGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = auv_msgs.msg.HomingGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = auv_msgs.msg.HomingGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.goal.beacon.north, _x.goal.beacon.east, _x.goal.beacon.depth))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.beacon.north, _x.goal.beacon.east, _x.goal.beacon.depth,) = _struct_3d.unpack(str[start:end])
      return self
