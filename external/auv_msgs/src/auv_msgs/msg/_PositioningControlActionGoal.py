"""autogenerated by genpy from auv_msgs/PositioningControlActionGoal.msg. Do not edit."""
import sys
...
class PositioningControlActionGoal(genpy.Message):
  _md5sum = "47a4e15a00579d2c8a2294e81a1b3bfe"
  _type = "auv_msgs/PositioningControlActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','auv_msgs/PositioningControlGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PositioningControlActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = auv_msgs.msg.PositioningControlGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = auv_msgs.msg.PositioningControlGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3f3I.pack(_x.goal.pose.position.north, _x.goal.pose.position.east, _x.goal.pose.position.depth, _x.goal.pose.orientation.roll, _x.goal.pose.orientation.pitch, _x.goal.pose.orientation.yaw, _x.goal.trajectory.header.seq, _x.goal.trajectory.header.stamp.secs, _x.goal.trajectory.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.goal.trajectory.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.trajectory.poses:
        _v1 = val1.position
        _x = _v1
      ...
      buff.write(_struct_d.pack(self.goal.duration))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.pose.position.north, _x.goal.pose.position.east, _x.goal.pose.position.depth, _x.goal.pose.orientation.roll, _x.goal.pose.orientation.pitch, _x.goal.pose.orientation.yaw, _x.goal.trajectory.header.seq, _x.goal.trajectory.header.stamp.secs, _x.goal.trajectory.header.stamp.nsecs,) = _struct_3d3f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      for i in range(0, length):
        ...
        self.goal.trajectory.poses.append(val1)
      start = end
      end += 8
      (self.goal.duration,) = _struct_d.unpack(str[start:end])
      return self
