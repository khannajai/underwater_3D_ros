"""autogenerated by genpy from auv_msgs/StayWaypointReq.msg. Do not edit."""
import sys
...
class StayWaypointReq(genpy.Message):
  _md5sum = "669505d5bfd6c5bc3c0e36dd25725479"
  _type = "auv_msgs/StayWaypointReq"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Position holding request to pilot.
...
"""
  __slots__ = ['header','goal','altitude_mode','disable_axis','position_tolerance','orientation_tolerance']
  _slot_types = ['std_msgs/Header','auv_msgs/GoalDescriptor','bool','auv_msgs/Bool6Axis','geometry_msgs/Vector3','auv_msgs/RPY']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,goal,altitude_mode,disable_axis,position_tolerance,orientation_tolerance
    ...
    """
    if args or kwds:
      super(StayWaypointReq, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I7B3d3f.pack(_x.goal.id, _x.goal.priority, _x.altitude_mode, _x.disable_axis.x, _x.disable_axis.y, _x.disable_axis.z, _x.disable_axis.roll, _x.disable_axis.pitch, _x.disable_axis.yaw, _x.position_tolerance.x, _x.position_tolerance.y, _x.position_tolerance.z, _x.orientation_tolerance.roll, _x.orientation_tolerance.pitch, _x.orientation_tolerance.yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.id, _x.goal.priority, _x.altitude_mode, _x.disable_axis.x, _x.disable_axis.y, _x.disable_axis.z, _x.disable_axis.roll, _x.disable_axis.pitch, _x.disable_axis.yaw, _x.position_tolerance.x, _x.position_tolerance.y, _x.position_tolerance.z, _x.orientation_tolerance.roll, _x.orientation_tolerance.pitch, _x.orientation_tolerance.yaw,) = _struct_2I7B3d3f.unpack(str[start:end])
...
_struct_2I7B3d3f = struct.Struct("<2I7B3d3f")
