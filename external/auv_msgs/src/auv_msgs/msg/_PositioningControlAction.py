"""autogenerated by genpy from auv_msgs/PositioningControlAction.msg. Do not edit."""
import sys
...
class PositioningControlAction(genpy.Message):
  _md5sum = "fbbadc654655cd527cabf8adaad82f5d"
  _type = "auv_msgs/PositioningControlAction"
...
"""
  ...
  _slot_types = ['auv_msgs/PositioningControlActionGoal','auv_msgs/PositioningControlActionResult','auv_msgs/PositioningControlActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PositioningControlAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.PositioningControlActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.PositioningControlActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.PositioningControlActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.PositioningControlActionGoal()
      self.action_result = auv_msgs.msg.PositioningControlActionResult()
      self.action_feedback = auv_msgs.msg.PositioningControlActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3f3I.pack(_x.action_goal.goal.pose.position.north, _x.action_goal.goal.pose.position.east, _x.action_goal.goal.pose.position.depth, _x.action_goal.goal.pose.orientation.roll, _x.action_goal.goal.pose.orientation.pitch, _x.action_goal.goal.pose.orientation.yaw, _x.action_goal.goal.trajectory.header.seq, _x.action_goal.goal.trajectory.header.stamp.secs, _x.action_goal.goal.trajectory.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.trajectory.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.trajectory.poses:
        _v1 = val1.position
        _x = _v1
      ...
      _x = self
      buff.write(_struct_d3I.pack(_x.action_goal.goal.duration, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.pose.position.north, _x.action_goal.goal.pose.position.east, _x.action_goal.goal.pose.position.depth, _x.action_goal.goal.pose.orientation.roll, _x.action_goal.goal.pose.orientation.pitch, _x.action_goal.goal.pose.orientation.yaw, _x.action_goal.goal.trajectory.header.seq, _x.action_goal.goal.trajectory.header.stamp.secs, _x.action_goal.goal.trajectory.header.stamp.nsecs,) = _struct_3d3f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.trajectory.poses = []
      for i in range(0, length):
        ...
        self.action_goal.goal.trajectory.poses.append(val1)
      _x = self
      start = end
      end += 20
      (_x.action_goal.goal.duration, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
