"""autogenerated by genpy from auv_msgs/InspectionProblem2Action.msg. Do not edit."""
import sys
...
class InspectionProblem2Action(genpy.Message):
  _md5sum = "7aab0a5c8a15aa35657700219000c71a"
  _type = "auv_msgs/InspectionProblem2Action"
...
"""
  ...
  _slot_types = ['auv_msgs/InspectionProblem2ActionGoal','auv_msgs/InspectionProblem2ActionResult','auv_msgs/InspectionProblem2ActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(InspectionProblem2Action, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.InspectionProblem2ActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.InspectionProblem2ActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.InspectionProblem2ActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.InspectionProblem2ActionGoal()
      self.action_result = auv_msgs.msg.InspectionProblem2ActionResult()
      self.action_feedback = auv_msgs.msg.InspectionProblem2ActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.map_dae_path
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.ips_path
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.map_dae_path = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.map_dae_path = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.ips_path = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.ips_path = str[start:end]
      _x = self
      start = end
      end += 12
