"""autogenerated by genpy from auv_msgs/FollowLeaderWithPathActionResult.msg. Do not edit."""
import sys
...
class FollowLeaderWithPathActionResult(genpy.Message):
  _md5sum = "196c5e4c2db3daa28449672de3b74a1d"
  _type = "auv_msgs/FollowLeaderWithPathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/FollowLeaderWithPathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowLeaderWithPathActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.FollowLeaderWithPathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.FollowLeaderWithPathResult()
