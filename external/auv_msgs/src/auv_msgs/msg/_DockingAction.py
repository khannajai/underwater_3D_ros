"""autogenerated by genpy from auv_msgs/DockingAction.msg. Do not edit."""
import sys
...
class DockingAction(genpy.Message):
  _md5sum = "b99ccdfbe5c8ea3cd2e89301a435bd24"
  _type = "auv_msgs/DockingAction"
...
"""
  ...
  _slot_types = ['auv_msgs/DockingActionGoal','auv_msgs/DockingActionResult','auv_msgs/DockingActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.DockingActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.DockingActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.DockingActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.DockingActionGoal()
      self.action_result = auv_msgs.msg.DockingActionResult()
      self.action_feedback = auv_msgs.msg.DockingActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.action_goal.goal.beacon.north, _x.action_goal.goal.beacon.east, _x.action_goal.goal.beacon.depth, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_I.pack(self.action_feedback.feedback.current_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.beacon.north, _x.action_goal.goal.beacon.east, _x.action_goal.goal.beacon.depth, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.current_distance,) = _struct_I.unpack(str[start:end])
      return self
