"""autogenerated by genpy from auv_msgs/PerformInterventionStrategyAction.msg. Do not edit."""
import sys
...
class PerformInterventionStrategyAction(genpy.Message):
  _md5sum = "59102e57ee8372c34b75770c7d320b10"
  _type = "auv_msgs/PerformInterventionStrategyAction"
...
"""
  ...
  _slot_types = ['auv_msgs/PerformInterventionStrategyActionGoal','auv_msgs/PerformInterventionStrategyActionResult','auv_msgs/PerformInterventionStrategyActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PerformInterventionStrategyAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.PerformInterventionStrategyActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.PerformInterventionStrategyActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.PerformInterventionStrategyActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.PerformInterventionStrategyActionGoal()
      self.action_result = auv_msgs.msg.PerformInterventionStrategyActionResult()
      self.action_feedback = auv_msgs.msg.PerformInterventionStrategyActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.intervention_spec_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_5I.pack(_x.action_goal.goal.task_index, _x.action_goal.goal.strategy_index, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_f3i.pack(_x.action_feedback.feedback.percent_complete, _x.action_feedback.feedback.est_time_left.data.secs, _x.action_feedback.feedback.est_time_left.data.nsecs, _x.action_feedback.feedback.step))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.intervention_spec_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.intervention_spec_id = str[start:end]
      _x = self
      start = end
      end += 20
      (_x.action_goal.goal.task_index, _x.action_goal.goal.strategy_index, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_5I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.percent_complete, _x.action_feedback.feedback.est_time_left.data.secs, _x.action_feedback.feedback.est_time_left.data.nsecs, _x.action_feedback.feedback.step,) = _struct_f3i.unpack(str[start:end])
      return self
