"""autogenerated by genpy from auv_msgs/McmGenerateInspectionpointsAction.msg. Do not edit."""
import sys
...
class McmGenerateInspectionpointsAction(genpy.Message):
  _md5sum = "5703643ebd285fa3415c994efb918130"
  _type = "auv_msgs/McmGenerateInspectionpointsAction"
...
"""
  ...
  _slot_types = ['auv_msgs/McmGenerateInspectionpointsActionGoal','auv_msgs/McmGenerateInspectionpointsActionResult','auv_msgs/McmGenerateInspectionpointsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(McmGenerateInspectionpointsAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.McmGenerateInspectionpointsActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.McmGenerateInspectionpointsActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.McmGenerateInspectionpointsActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.McmGenerateInspectionpointsActionGoal()
      self.action_result = auv_msgs.msg.McmGenerateInspectionpointsActionResult()
      self.action_feedback = auv_msgs.msg.McmGenerateInspectionpointsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.result.inspectionpoints.header.seq, _x.action_result.result.inspectionpoints.header.stamp.secs, _x.action_result.result.inspectionpoints.header.stamp.nsecs))
      _x = self.action_result.result.inspectionpoints.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.inspectionpoints.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.inspectionpoints.poses:
        _v1 = val1.position
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.inspectionpoints.header.seq, _x.action_result.result.inspectionpoints.header.stamp.secs, _x.action_result.result.inspectionpoints.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.inspectionpoints.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.inspectionpoints.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.inspectionpoints.poses = []
      for i in range(0, length):
        ...
        self.action_result.result.inspectionpoints.poses.append(val1)
      _x = self
      start = end
      end += 5
