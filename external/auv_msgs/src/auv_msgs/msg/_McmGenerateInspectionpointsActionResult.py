"""autogenerated by genpy from auv_msgs/McmGenerateInspectionpointsActionResult.msg. Do not edit."""
import sys
...
class McmGenerateInspectionpointsActionResult(genpy.Message):
  _md5sum = "88675d4ce7314903d387ec7b6a570cba"
  _type = "auv_msgs/McmGenerateInspectionpointsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/McmGenerateInspectionpointsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(McmGenerateInspectionpointsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.McmGenerateInspectionpointsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.McmGenerateInspectionpointsResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.result.inspectionpoints.header.seq, _x.result.inspectionpoints.header.stamp.secs, _x.result.inspectionpoints.header.stamp.nsecs))
      _x = self.result.inspectionpoints.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.inspectionpoints.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.inspectionpoints.poses:
        _v1 = val1.position
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.inspectionpoints.header.seq, _x.result.inspectionpoints.header.stamp.secs, _x.result.inspectionpoints.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.inspectionpoints.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.result.inspectionpoints.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.inspectionpoints.poses = []
      for i in range(0, length):
        ...
        self.result.inspectionpoints.poses.append(val1)
      _x = self
      start = end
      end += 5
