"""autogenerated by genpy from auv_msgs/SonarObserveAction.msg. Do not edit."""
import sys
...
class SonarObserveAction(genpy.Message):
  _md5sum = "0c7131d59487fee2911f37808901562e"
  _type = "auv_msgs/SonarObserveAction"
...
"""
  ...
  _slot_types = ['auv_msgs/SonarObserveActionGoal','auv_msgs/SonarObserveActionResult','auv_msgs/SonarObserveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SonarObserveAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.SonarObserveActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.SonarObserveActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.SonarObserveActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.SonarObserveActionGoal()
      self.action_result = auv_msgs.msg.SonarObserveActionResult()
      self.action_feedback = auv_msgs.msg.SonarObserveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3f3d5I.pack(_x.action_goal.goal.waypoint.position.north, _x.action_goal.goal.waypoint.position.east, _x.action_goal.goal.waypoint.position.depth, _x.action_goal.goal.waypoint.orientation.roll, _x.action_goal.goal.waypoint.orientation.pitch, _x.action_goal.goal.waypoint.orientation.yaw, _x.action_goal.goal.inspectionpoint.north, _x.action_goal.goal.inspectionpoint.east, _x.action_goal.goal.inspectionpoint.depth, _x.action_goal.goal.minimum_duration.secs, _x.action_goal.goal.minimum_duration.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.waypoint.position.north, _x.action_goal.goal.waypoint.position.east, _x.action_goal.goal.waypoint.position.depth, _x.action_goal.goal.waypoint.orientation.roll, _x.action_goal.goal.waypoint.orientation.pitch, _x.action_goal.goal.waypoint.orientation.yaw, _x.action_goal.goal.inspectionpoint.north, _x.action_goal.goal.inspectionpoint.east, _x.action_goal.goal.inspectionpoint.depth, _x.action_goal.goal.minimum_duration.secs, _x.action_goal.goal.minimum_duration.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3d3f3d5I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
_struct_3d3f3d5I = struct.Struct("<3d3f3d5I")
