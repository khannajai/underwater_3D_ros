"""autogenerated by genpy from auv_msgs/McmClusterCircleDetectionsAction.msg. Do not edit."""
import sys
...
class McmClusterCircleDetectionsAction(genpy.Message):
  _md5sum = "a36d2ac1559b8e5054f0bcaf97a69cd0"
  _type = "auv_msgs/McmClusterCircleDetectionsAction"
...
"""
  ...
  _slot_types = ['auv_msgs/McmClusterCircleDetectionsActionGoal','auv_msgs/McmClusterCircleDetectionsActionResult','auv_msgs/McmClusterCircleDetectionsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(McmClusterCircleDetectionsAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.McmClusterCircleDetectionsActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.McmClusterCircleDetectionsActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.McmClusterCircleDetectionsActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.McmClusterCircleDetectionsActionGoal()
      self.action_result = auv_msgs.msg.McmClusterCircleDetectionsActionResult()
      self.action_feedback = auv_msgs.msg.McmClusterCircleDetectionsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.completed
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.completed = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.completed = str[start:end]
      _x = self
      start = end
      end += 12
