"""autogenerated by genpy from auv_msgs/InspectionProblemActionFeedback.msg. Do not edit."""
import sys
...
class InspectionProblemActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "auv_msgs/InspectionProblemActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/InspectionProblemFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(InspectionProblemActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = auv_msgs.msg.InspectionProblemFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = auv_msgs.msg.InspectionProblemFeedback()
