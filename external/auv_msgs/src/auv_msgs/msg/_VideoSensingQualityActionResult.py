"""autogenerated by genpy from auv_msgs/VideoSensingQualityActionResult.msg. Do not edit."""
import sys
...
class VideoSensingQualityActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "auv_msgs/VideoSensingQualityActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/VideoSensingQualityResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VideoSensingQualityActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.VideoSensingQualityResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.VideoSensingQualityResult()
