"""autogenerated by genpy from auv_msgs/FollowTerrainWithPathActionGoal.msg. Do not edit."""
import sys
...
class FollowTerrainWithPathActionGoal(genpy.Message):
  _md5sum = "1159526b818f0ae9b25faeea737092b7"
  _type = "auv_msgs/FollowTerrainWithPathActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','auv_msgs/FollowTerrainWithPathGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowTerrainWithPathActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = auv_msgs.msg.FollowTerrainWithPathGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = auv_msgs.msg.FollowTerrainWithPathGoal()
