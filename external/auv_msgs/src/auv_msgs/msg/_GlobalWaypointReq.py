"""autogenerated by genpy from auv_msgs/GlobalWaypointReq.msg. Do not edit."""
import sys
...
class GlobalWaypointReq(genpy.Message):
  _md5sum = "f90e850f757b53f3641907daf353af05"
  _type = "auv_msgs/GlobalWaypointReq"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Global frame (absolute) waypoint request to pilot.
...
float64 z
"""
  __slots__ = ['header','goal','altitude_mode','position','depth','altitude','orientation','disable_axis','position_tolerance','orientation_tolerance']
  _slot_types = ['std_msgs/Header','auv_msgs/GoalDescriptor','bool','auv_msgs/DecimalLatLon','float32','float32','auv_msgs/RPY','auv_msgs/Bool6Axis','geometry_msgs/Vector3','auv_msgs/RPY']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,goal,altitude_mode,position,depth,altitude,orientation,disable_axis,position_tolerance,orientation_tolerance
    ...
    """
    if args or kwds:
      super(GlobalWaypointReq, self).__init__(*args, **kwds)
      ...
      if self.position is None:
        self.position = auv_msgs.msg.DecimalLatLon()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2IB2d5f6B3d3f.pack(_x.goal.id, _x.goal.priority, _x.altitude_mode, _x.position.latitude, _x.position.longitude, _x.depth, _x.altitude, _x.orientation.roll, _x.orientation.pitch, _x.orientation.yaw, _x.disable_axis.x, _x.disable_axis.y, _x.disable_axis.z, _x.disable_axis.roll, _x.disable_axis.pitch, _x.disable_axis.yaw, _x.position_tolerance.x, _x.position_tolerance.y, _x.position_tolerance.z, _x.orientation_tolerance.roll, _x.orientation_tolerance.pitch, _x.orientation_tolerance.yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.id, _x.goal.priority, _x.altitude_mode, _x.position.latitude, _x.position.longitude, _x.depth, _x.altitude, _x.orientation.roll, _x.orientation.pitch, _x.orientation.yaw, _x.disable_axis.x, _x.disable_axis.y, _x.disable_axis.z, _x.disable_axis.roll, _x.disable_axis.pitch, _x.disable_axis.yaw, _x.position_tolerance.x, _x.position_tolerance.y, _x.position_tolerance.z, _x.orientation_tolerance.roll, _x.orientation_tolerance.pitch, _x.orientation_tolerance.yaw,) = _struct_2IB2d5f6B3d3f.unpack(str[start:end])
...
_struct_2IB2d5f6B3d3f = struct.Struct("<2IB2d5f6B3d3f")
