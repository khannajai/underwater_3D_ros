"""autogenerated by genpy from auv_msgs/WorldWaypointReq.msg. Do not edit."""
import sys
...
class WorldWaypointReq(genpy.Message):
  _md5sum = "d9c3dd9da5e8464e90786e504d890720"
  _type = "auv_msgs/WorldWaypointReq"
...
float64 z
"""
  __slots__ = ['header','goal','altitude_mode','position','altitude','orientation','disable_axis','position_tolerance','orientation_tolerance','max_speed_percent']
  _slot_types = ['std_msgs/Header','auv_msgs/GoalDescriptor','bool','auv_msgs/NED','float32','auv_msgs/RPY','auv_msgs/Bool6Axis','geometry_msgs/Vector3','auv_msgs/RPY','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,goal,altitude_mode,position,altitude,orientation,disable_axis,position_tolerance,orientation_tolerance,max_speed_percent
    ...
    if args or kwds:
      ...
      if self.max_speed_percent is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2IB3d4f6B3d3fb.pack(_x.goal.id, _x.goal.priority, _x.altitude_mode, _x.position.north, _x.position.east, _x.position.depth, _x.altitude, _x.orientation.roll, _x.orientation.pitch, _x.orientation.yaw, _x.disable_axis.x, _x.disable_axis.y, _x.disable_axis.z, _x.disable_axis.roll, _x.disable_axis.pitch, _x.disable_axis.yaw, _x.position_tolerance.x, _x.position_tolerance.y, _x.position_tolerance.z, _x.orientation_tolerance.roll, _x.orientation_tolerance.pitch, _x.orientation_tolerance.yaw, _x.max_speed_percent))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.id, _x.goal.priority, _x.altitude_mode, _x.position.north, _x.position.east, _x.position.depth, _x.altitude, _x.orientation.roll, _x.orientation.pitch, _x.orientation.yaw, _x.disable_axis.x, _x.disable_axis.y, _x.disable_axis.z, _x.disable_axis.roll, _x.disable_axis.pitch, _x.disable_axis.yaw, _x.position_tolerance.x, _x.position_tolerance.y, _x.position_tolerance.z, _x.orientation_tolerance.roll, _x.orientation_tolerance.pitch, _x.orientation_tolerance.yaw, _x.max_speed_percent,) = _struct_2IB3d4f6B3d3fb.unpack(str[start:end])
...
_struct_2IB3d4f6B3d3fb = struct.Struct("<2IB3d4f6B3d3fb")
