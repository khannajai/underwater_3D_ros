"""autogenerated by genpy from auv_msgs/EnterDockActionFeedback.msg. Do not edit."""
import sys
...
class EnterDockActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "auv_msgs/EnterDockActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/EnterDockFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EnterDockActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = auv_msgs.msg.EnterDockFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = auv_msgs.msg.EnterDockFeedback()
