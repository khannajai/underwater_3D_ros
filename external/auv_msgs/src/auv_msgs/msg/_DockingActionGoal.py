"""autogenerated by genpy from auv_msgs/DockingActionGoal.msg. Do not edit."""
import sys
...
class DockingActionGoal(genpy.Message):
  ...
  _type = "auv_msgs/DockingActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','auv_msgs/DockingGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = auv_msgs.msg.DockingGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = auv_msgs.msg.DockingGoal()
