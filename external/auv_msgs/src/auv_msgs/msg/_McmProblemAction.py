"""autogenerated by genpy from auv_msgs/McmProblemAction.msg. Do not edit."""
import sys
...
class McmProblemAction(genpy.Message):
  _md5sum = "e2008584777739b04a727ab2a9ffb464"
  _type = "auv_msgs/McmProblemAction"
...
"""
  ...
  _slot_types = ['auv_msgs/McmProblemActionGoal','auv_msgs/McmProblemActionResult','auv_msgs/McmProblemActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(McmProblemAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.McmProblemActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.McmProblemActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.McmProblemActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.McmProblemActionGoal()
      self.action_result = auv_msgs.msg.McmProblemActionResult()
      self.action_feedback = auv_msgs.msg.McmProblemActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_goal.goal.testing.radius, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.testing.radius, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
