"""autogenerated by genpy from auv_msgs/GenerateWaypointsResult.msg. Do not edit."""
import sys
...
class GenerateWaypointsResult(genpy.Message):
  _md5sum = "5b070ecccdeca6bdc0c41bd515e6387b"
  _type = "auv_msgs/GenerateWaypointsResult"
...
"""
  ...
  __slots__ = ['waypoints','inspectionpoints','success','error_num','error_string']
  _slot_types = ['auv_msgs/VehiclePoseArray','auv_msgs/NEDArray','bool','int32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       waypoints,inspectionpoints,success,error_num,error_string
    ...
    """
    if args or kwds:
      super(GenerateWaypointsResult, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.waypoints is None:
        self.waypoints = auv_msgs.msg.VehiclePoseArray()
      if self.inspectionpoints is None:
        self.inspectionpoints = auv_msgs.msg.NEDArray()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.inspectionpoints.neds)
      buff.write(_struct_I.pack(length))
      for val1 in self.inspectionpoints.neds:
        _x = val1
        buff.write(_struct_3d.pack(_x.north, _x.east, _x.depth))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.north, _x.east, _x.depth,) = _struct_3d.unpack(str[start:end])
        self.inspectionpoints.neds.append(val1)
      _x = self
      start = end
      end += 5
