"""autogenerated by genpy from auv_msgs/FollowTerrainWithPathActionResult.msg. Do not edit."""
import sys
...
class FollowTerrainWithPathActionResult(genpy.Message):
  _md5sum = "9cd21762fe72ccda7bef5f960514fa58"
  _type = "auv_msgs/FollowTerrainWithPathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/FollowTerrainWithPathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowTerrainWithPathActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.FollowTerrainWithPathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.FollowTerrainWithPathResult()
