"""autogenerated by genpy from auv_msgs/SonarInspectActionFeedback.msg. Do not edit."""
import sys
...
class SonarInspectActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "auv_msgs/SonarInspectActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/SonarInspectFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SonarInspectActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = auv_msgs.msg.SonarInspectFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = auv_msgs.msg.SonarInspectFeedback()
