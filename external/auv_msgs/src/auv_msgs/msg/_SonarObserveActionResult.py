"""autogenerated by genpy from auv_msgs/SonarObserveActionResult.msg. Do not edit."""
import sys
...
class SonarObserveActionResult(genpy.Message):
  _md5sum = "9cd21762fe72ccda7bef5f960514fa58"
  _type = "auv_msgs/SonarObserveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/SonarObserveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SonarObserveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.SonarObserveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.SonarObserveResult()
