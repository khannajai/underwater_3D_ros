"""autogenerated by genpy from auv_msgs/SonarInspectAction.msg. Do not edit."""
import sys
...
class SonarInspectAction(genpy.Message):
  _md5sum = "c4176d36f9b401eab2fa1a03d0ccf448"
  _type = "auv_msgs/SonarInspectAction"
...
"""
  ...
  _slot_types = ['auv_msgs/SonarInspectActionGoal','auv_msgs/SonarInspectActionResult','auv_msgs/SonarInspectActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SonarInspectAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = auv_msgs.msg.SonarInspectActionGoal()
      if self.action_result is None:
        self.action_result = auv_msgs.msg.SonarInspectActionResult()
      if self.action_feedback is None:
        self.action_feedback = auv_msgs.msg.SonarInspectActionFeedback()
    else:
      self.action_goal = auv_msgs.msg.SonarInspectActionGoal()
      self.action_result = auv_msgs.msg.SonarInspectActionResult()
      self.action_feedback = auv_msgs.msg.SonarInspectActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3f5I.pack(_x.action_goal.goal.pose.position.north, _x.action_goal.goal.pose.position.east, _x.action_goal.goal.pose.position.depth, _x.action_goal.goal.pose.orientation.roll, _x.action_goal.goal.pose.orientation.pitch, _x.action_goal.goal.pose.orientation.yaw, _x.action_goal.goal.minimum_duration.secs, _x.action_goal.goal.minimum_duration.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.pose.position.north, _x.action_goal.goal.pose.position.east, _x.action_goal.goal.pose.position.depth, _x.action_goal.goal.pose.orientation.roll, _x.action_goal.goal.pose.orientation.pitch, _x.action_goal.goal.pose.orientation.yaw, _x.action_goal.goal.minimum_duration.secs, _x.action_goal.goal.minimum_duration.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3d3f5I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
_struct_3d3f5I = struct.Struct("<3d3f5I")
