"""autogenerated by genpy from auv_msgs/LeaveDockActionResult.msg. Do not edit."""
import sys
...
class LeaveDockActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "auv_msgs/LeaveDockActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/LeaveDockResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LeaveDockActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.LeaveDockResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.LeaveDockResult()
