"""autogenerated by genpy from auv_msgs/LocaliseInMosaicActionResult.msg. Do not edit."""
import sys
...
class LocaliseInMosaicActionResult(genpy.Message):
  _md5sum = "d7ccb420439fb0f7fc1ff57e12918cfe"
  _type = "auv_msgs/LocaliseInMosaicActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/LocaliseInMosaicResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocaliseInMosaicActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.LocaliseInMosaicResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.LocaliseInMosaicResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I.pack(_x.result.frame_count, _x.result.identified_frame_count))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.frame_count, _x.result.identified_frame_count,) = _struct_2I.unpack(str[start:end])
      return self
