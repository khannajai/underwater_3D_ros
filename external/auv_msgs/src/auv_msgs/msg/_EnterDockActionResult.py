"""autogenerated by genpy from auv_msgs/EnterDockActionResult.msg. Do not edit."""
import sys
...
class EnterDockActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "auv_msgs/EnterDockActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/EnterDockResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EnterDockActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.EnterDockResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.EnterDockResult()
