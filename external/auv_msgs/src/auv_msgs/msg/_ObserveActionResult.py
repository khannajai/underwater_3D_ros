"""autogenerated by genpy from auv_msgs/ObserveActionResult.msg. Do not edit."""
import sys
...
class ObserveActionResult(genpy.Message):
  _md5sum = "9cd21762fe72ccda7bef5f960514fa58"
  _type = "auv_msgs/ObserveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_msgs/ObserveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObserveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = auv_msgs.msg.ObserveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = auv_msgs.msg.ObserveResult()
