"""autogenerated by genpy from nessie_msgs/TeledyneExplDvl.msg. Do not edit."""
import sys
...
class TeledyneExplDvl(genpy.Message):
  _md5sum = "055077ee78c1cdff00a67f26328530ba"
  _type = "nessie_msgs/TeledyneExplDvl"
...
"""
  __slots__ = ['header','header_dvl','date','salinity','temperature','depth','sound_speed','test','pressure','range_to_bottom1','range_to_bottom2','range_to_bottom3','range_to_bottom4','wi_x_axis','wi_y_axis','wi_z_axis','wi_error','wi_status','bi_x_axis','bi_y_axis','bi_z_axis','bi_error','bi_status','ws_transverse','ws_longitudinal','ws_normal','ws_status','bs_transverse','bs_longitudinal','bs_normal','bs_status','we_east','we_north','we_upwards','we_status','be_east','be_north','be_upwards','be_status','wd_east','wd_north','wd_upwards','wd_range','wd_time','bd_east','bd_north','bd_upwards','bd_range','bd_time','raw_data']
  _slot_types = ['std_msgs/Header','string','string','float64','float64','float64','float64','int32','float64','float64','float64','float64','float64','float64','float64','float64','float64','string','float64','float64','float64','float64','string','float64','float64','float64','string','float64','float64','float64','string','float64','float64','float64','string','float64','float64','float64','string','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,header_dvl,date,salinity,temperature,depth,sound_speed,test,pressure,range_to_bottom1,range_to_bottom2,range_to_bottom3,range_to_bottom4,wi_x_axis,wi_y_axis,wi_z_axis,wi_error,wi_status,bi_x_axis,bi_y_axis,bi_z_axis,bi_error,bi_status,ws_transverse,ws_longitudinal,ws_normal,ws_status,bs_transverse,bs_longitudinal,bs_normal,bs_status,we_east,we_north,we_upwards,we_status,be_east,be_north,be_upwards,be_status,wd_east,wd_north,wd_upwards,wd_range,wd_time,bd_east,bd_north,bd_upwards,bd_range,bd_time,raw_data
    ...
    """
    if args or kwds:
      super(TeledyneExplDvl, self).__init__(*args, **kwds)
      ...
      if self.pressure is None:
        self.pressure = 0.
      if self.range_to_bottom1 is None:
        self.range_to_bottom1 = 0.
      if self.range_to_bottom2 is None:
        self.range_to_bottom2 = 0.
      if self.range_to_bottom3 is None:
        self.range_to_bottom3 = 0.
      if self.range_to_bottom4 is None:
        self.range_to_bottom4 = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4di9d.pack(_x.salinity, _x.temperature, _x.depth, _x.sound_speed, _x.test, _x.pressure, _x.range_to_bottom1, _x.range_to_bottom2, _x.range_to_bottom3, _x.range_to_bottom4, _x.wi_x_axis, _x.wi_y_axis, _x.wi_z_axis, _x.wi_error))
      _x = self.wi_status
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.salinity, _x.temperature, _x.depth, _x.sound_speed, _x.test, _x.pressure, _x.range_to_bottom1, _x.range_to_bottom2, _x.range_to_bottom3, _x.range_to_bottom4, _x.wi_x_axis, _x.wi_y_axis, _x.wi_z_axis, _x.wi_error,) = _struct_4di9d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
_struct_4di9d = struct.Struct("<4di9d")
